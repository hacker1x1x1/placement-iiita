...
?>
		...
		<div class="row block" id="campus_images">
			...
			<div class="col s10 offset-s1 body">
				<img src="images/iiita/campus6.jpg" alt="IIITA" class="materialboxed col m3 s10 offset-s1 responsive-img">
			...
			<div class="col s10 offset-s1 body">
				<img src="images/iiita/campus20.jpg" alt="IIITA" class="materialboxed col m3 s10 offset-s1 responsive-img">
